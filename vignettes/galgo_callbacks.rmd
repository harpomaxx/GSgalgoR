...
galgoR::galgo(generations = 6, 
  ...
  report_callback = my_callback,      # call `my_callback()` in the middle 
...
galgoR::galgo(
  ...
  report_callback = my_callback,      # call `my_callback()` in the middle 
                                      # of each generation/iteration.
  start_gen_callback = galgoR::callback_default,
  end_gen_callback = my_save_pop_callback , # call `my_save_pop_callback()` at
                                          #the end of each generation/iteration
  ) 
...
galgoR::galgo(
  ...
  report_callback = my_callback,      # call `my_callback()` in the middle of 
                                      # of each generation/iteration.
  start_gen_callback = galgoR::callback_default,
  end_gen_callback = galgoR::callback_default
  ) 
